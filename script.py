...
def setup_browser():
    ...
    # Reduce bandwidth consumption, increase speed by disabling images, Flash
...
def click_on_result(driver, options):
    if randomly_perform_action() and options.click_on_results:
